...
public class MainActivity extends AppCompatActivity {
    ...
    // After the user has authorized access to the data requested, create the desired GoogleApi client (e.g. a HistoryClient to read and/or write historic fitness data) for the purposes of your app:
        ...
        Fitness.getHistoryClient(this, GoogleSignIn.getLastSignedInAccount(this))
                ...
                .addOnSuccessListener(new OnSuccessListener<DataReadResponse>() {
                    ...
                    public void onSuccess(DataReadResponse dataReadResponse) {
                        Log.d("BAD BITCH", "onSuccess()");
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.e("FUCK", "onFailure()", e);
                    }
                })
                .addOnCompleteListener(new OnCompleteListener<DataReadResponse>() {
                    @Override
                    public void onComplete(@NonNull Task<DataReadResponse> task) {
                        Log.d("YEET BOI", "onComplete()");
                    }
                });
    }
}
